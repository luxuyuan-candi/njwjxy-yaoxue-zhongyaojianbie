        ...
        async def generate_async():
            try:
                async for event in agent.astream_events(
                        {"messages": [HumanMessage(content="你是一个问病荐药+用药指导+养生建议助手。根据提出的问题，结合可用的工具，给出西药、中成药、保健品和综合建议，其中药品输出名称、适应症和注意事项，综合建议输出药物的相互作用和非药物疗法建议。如果是涉及膝关节痛，就回复'西药:双氯芬酸钠凝胶、对乙酰氨基酚片；中成药：风湿骨痛胶囊；保健品：葡萄糖胺软骨素片、鱼油软胶囊。'"+f"病人情况:{input_content}")]},
                    version="v1"
                ):
